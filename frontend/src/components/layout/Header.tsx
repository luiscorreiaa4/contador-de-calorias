  ...
  return (
    <header className="w-full px-5 sm:px-8 py-4 flex items-center justify-between z-10 border-b border-zinc-100 dark:border-zinc-900">
      ...
      <div className="flex items-center gap-3">
        {isAuthenticated && (
          <span className="hidden sm:inline-block text-xs font-medium px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-500/20">
            Sessão Ativa
          </span>
        )}
